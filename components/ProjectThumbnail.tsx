...
export default function ProjectThumbnail({ projectId }: ProjectThumbnailProps) {
  ...
  if (projectId === 10) return (
    <svg aria-hidden="true" width="100%" height="100%" viewBox="0 0 400 200" preserveAspectRatio="xMidYMid slice" xmlns="http://www.w3.org/2000/svg">
      ...
      <rect x="28" y="22" width="130" height="162" rx="4" fill={PANEL} stroke={PANEL_BORDER} strokeWidth="1" />
      <rect x="42" y="36" width="90" height="7" rx="2" fill={INK} opacity="0.28" />
      <rect x="42" y="48" width="65" height="4" rx="2" fill={MUTED} opacity="0.3" />
      {[0,1,2,3,4,5,6,7,8].map(i => (
        <rect key={i} x="42" y={60+i*13} width={70+(i%3)*16} height="4" rx="2" fill={MUTED} opacity="0.22" />
      ))}
      <rect x="28" y="22" width="130" height="2" rx="1" fill={INK} opacity="0.35">
      ...
      {/* Right: LaTeX output */}
      <rect x="242" y="22" width="138" height="162" rx="4" fill={PANEL} stroke={PANEL_BORDER} strokeWidth="1" />
      {[
        ...
        <text key={i} x="250" y={38+i*17} fontSize="6.5" fill={MUTED} fontFamily="monospace" opacity="0">
          {row.t}
          <animate attributeName="opacity" values="0;0.6;0.6" dur="3.5s" repeatCount="indefinite" begin={row.delay} />
        </text>
      ))}
      <rect x="250" y="174" width="5" height="8" rx="1" fill={INK} opacity="0.4">
  ...
  if (projectId === 9) return (
    <svg aria-hidden="true" width="100%" height="100%" viewBox="0 0 400 200" preserveAspectRatio="xMidYMid slice" xmlns="http://www.w3.org/2000/svg">
      ...
      {[
        ...
        <g key={i} opacity="0">
          <rect x={b.x} y={b.y} width={b.w} height={26} rx={b.role==='user' ? '10 10 10 2' : '10 10 2 10'} fill={PANEL} stroke={PANEL_BORDER} strokeWidth="1" />
          <rect x={b.x+12} y={b.y+10} width={b.w-32} height="4" rx="2" fill={MUTED} opacity="0.3" />
          <animate attributeName="opacity" values="0;1;1" dur={`${5+i}s`} repeatCount="indefinite" begin={`${i*0.7}s`} />
        </g>
      ))}
      <line x1="200" y1="16" x2="200" y2="184" stroke={INK} strokeWidth="0.5" opacity="0.14" />
      <text x="216" y="32" fontSize="8" fill={MUTED} opacity="0.55" fontFamily="monospace">CURRICULUM</text>
      {[0,1,2,3,4].map(i => (
        <g key={i} opacity="0">
  ...
  if (projectId === 1) return (
    <svg aria-hidden="true" width="100%" height="100%" viewBox="0 0 400 200" preserveAspectRatio="xMidYMid slice" xmlns="http://www.w3.org/2000/svg">
      ...
      {[50, 100, 150].flatMap(y1 => ([40, 80, 120, 160]).map(y2 => (
        <line key={`${y1}-${y2}`} x1="80" y1={y1} x2="200" y2={y2} stroke={INK} strokeWidth="0.5" opacity="0.09" />
      )))}
      {[40, 80, 120, 160].flatMap(y1 => ([65, 135]).map(y2 => (
        <line key={`${y1}-${y2}`} x1="200" y1={y1} x2="320" y2={y2} stroke={INK} strokeWidth="0.5" opacity="0.09" />
      )))}
      {[50, 100, 150].map((y, i) => (
        <circle key={i} cx="80" cy={y} r="7" fill={PANEL} stroke={INK} strokeWidth="1" opacity="0.55">
          <animate attributeName="opacity" values="0.55;0.9;0.55" dur={`${1.8 + i * 0.4}s`} repeatCount="indefinite" begin={`${i * 0.25}s`} />
        </circle>
      ))}
      {[40, 80, 120, 160].map((y, i) => (
        <circle key={i} cx="200" cy={y} r="7" fill={PANEL} stroke={INK} strokeWidth="1" opacity="0.5">
      ...
      <polyline points="30,185 60,175 90,188 120,170 150,180 180,168 210,178 240,165 270,178 300,172 330,182 370,175" fill="none" stroke={INK} strokeWidth="1.2" opacity="0.22">
  ...
  if (projectId === 2) return (
    <svg aria-hidden="true" width="100%" height="100%" viewBox="0 0 400 200" preserveAspectRatio="xMidYMid slice" xmlns="http://www.w3.org/2000/svg">
      <rect width="400" height="200" fill={BG} />
      <line x1="50" y1="155" x2="260" y2="155" stroke={INK} strokeWidth="0.5" opacity="0.25" />
      {([
        ...
        <rect key={i} x={b.x} y={155-b.h} width="28" height={b.h} rx="2" fill={INK} opacity="0.16">
          ...
          <animate attributeName="opacity" values="0.16;0.3;0.16" dur={`${2.5+i*0.3}s`} repeatCount="indefinite" />
        </rect>
      ))}
      {[0,1,2,3,4].map(i => (
        <g key={i}>
          <rect x="290" y={48+i*22} width={40+(i%3)*18} height="5" rx="2" fill={MUTED} opacity="0.22" />
  ...
  if (projectId === 3) return (
    <svg aria-hidden="true" width="100%" height="100%" viewBox="0 0 400 200" preserveAspectRatio="xMidYMid slice" xmlns="http://www.w3.org/2000/svg">
      <rect width="400" height="200" fill={BG} />
      <g opacity="0">
        <rect x="30" y="28" width="150" height="34" rx="12" fill={PANEL} stroke={PANEL_BORDER} strokeWidth="1" />
        <rect x="46" y="38" width="65" height="5" rx="2" fill={MUTED} opacity="0.32" />
        <rect x="46" y="48" width="95" height="5" rx="2" fill={MUTED} opacity="0.2" />
        <animate attributeName="opacity" values="0;1;1;1;0;0" dur="7s" repeatCount="indefinite" begin="0s" />
      </g>
      <g opacity="0">
        <rect x="220" y="78" width="150" height="34" rx="12" fill={PANEL} stroke={PANEL_BORDER} strokeWidth="1" />
        <rect x="236" y="88" width="85" height="5" rx="2" fill={MUTED} opacity="0.32" />
        <rect x="236" y="98" width="55" height="5" rx="2" fill={MUTED} opacity="0.2" />
        <animate attributeName="opacity" values="0;0;0;1;1;0" dur="7s" repeatCount="indefinite" begin="0s" />
      </g>
      <g opacity="0">
        <rect x="30" y="126" width="190" height="34" rx="12" fill={PANEL} stroke={PANEL_BORDER} strokeWidth="1" />
        <rect x="46" y="136" width="105" height="5" rx="2" fill={MUTED} opacity="0.32" />
        <rect x="46" y="146" width="75" height="5" rx="2" fill={MUTED} opacity="0.2" />
      ...
      {[0,1,2].map(i => (
        <circle key={i} cx="370" cy="22" r={14+i*10} fill="none" stroke={INK} strokeWidth="0.7">
          <animate attributeName="r" values={`${14+i*10};${24+i*10};${14+i*10}`} dur="2.5s" repeatCount="indefinite" begin={`${i*0.35}s`} />
          <animate attributeName="opacity" values={`${0.18-i*0.05};0;${0.18-i*0.05}`} dur="2.5s" repeatCount="indefinite" begin={`${i*0.35}s`} />
        </circle>
      ))}
    </svg>
  );
  ...
  if (projectId === 4) return (
    <svg aria-hidden="true" width="100%" height="100%" viewBox="0 0 400 200" preserveAspectRatio="xMidYMid slice" xmlns="http://www.w3.org/2000/svg">
      <rect width="400" height="200" fill={BG} />
      <rect x="48" y="18" width="150" height="170" rx="4" fill={PANEL} stroke={PANEL_BORDER} strokeWidth="1" />
      <rect x="62" y="32" width="105" height="7" rx="2" fill={INK} opacity="0.28" />
      <rect x="62" y="46" width="72" height="4" rx="2" fill={MUTED} opacity="0.24" />
      {[0,1,2,3,4,5,6,7].map(i => (
        <rect key={i} x="62" y={58+i*14} width={75+(i%3)*18} height="4" rx="2" fill={MUTED} opacity="0.2" />
      ))}
      <rect x="48" y="18" width="150" height="2" rx="1" fill={INK} opacity="0.35">
        <animate attributeName="y" values="22;178;22" dur="2.6s" repeatCount="indefinite" />
        <animate attributeName="opacity" values="0.35;0.12;0.35" dur="2.6s" repeatCount="indefinite" />
      </rect>
      ...
      <rect x="248" y="114" width="94" height="4" rx="2" fill={PANEL_BORDER} />
      <rect x="248" y="114" width="0" height="4" rx="2" fill={INK} opacity="0.5">
        <animate attributeName="width" values="0;82;82;0" dur="3s" repeatCount="indefinite" />
      </rect>
      <text x="295" y="138" textAnchor="middle" fontSize="8" fill={MUTED} opacity="0.4" fontFamily="monospace">ANALYZING...</text>
    </svg>
  );
  ...
  if (projectId === 5) return (
    <svg aria-hidden="true" width="100%" height="100%" viewBox="0 0 400 200" preserveAspectRatio="xMidYMid slice" xmlns="http://www.w3.org/2000/svg">
      <rect width="400" height="200" fill={BG} />
      <rect x="28" y="18" width="344" height="166" rx="6" fill={PANEL} stroke={PANEL_BORDER} strokeWidth="1" />
      <rect x="28" y="18" width="344" height="26" rx="6" fill="var(--color-border)" />
      <circle cx="50" cy="31" r="4.5" fill={INK} opacity="0.25" />
      <circle cx="66" cy="31" r="4.5" fill={INK} opacity="0.2" />
      <circle cx="82" cy="31" r="4.5" fill={INK} opacity="0.15" />
      {([
        ...
        <g key={i}>
          ...
          <text x="302" y={63+i*30} fontSize="7.5" fill={MUTED} opacity="0.4" fontFamily="monospace">{Math.round(row.fill*100)}%</text>
        </g>
      ))}
    </svg>
  );
    ...
    <svg aria-hidden="true" width="100%" height="100%" viewBox="0 0 400 200" preserveAspectRatio="xMidYMid slice" xmlns="http://www.w3.org/2000/svg">
      ...
      {(['GPT-4o','Claude','Llama'] as string[]).map((name, i) => (
        <g key={i}>
          ...
          <text x="336" y={55+i*52} textAnchor="middle" fontSize="7.5" fill={MUTED} opacity="0.6" fontFamily="monospace">{name}</text>
        </g>
      ))}
      <line x1="140" y1="100" x2="198" y2="100" stroke={INK} strokeWidth="0.8" opacity="0.25" />
      <circle cx="170" cy="100" r="3" fill={INK} opacity="0">
      ...
      {([51,103,155] as number[]).map((y, i) => (
        <g key={i}>
          <line x1="240" y1="100" x2="300" y2={y} stroke={INK} strokeWidth="0.7" opacity="0.18" />
          <circle cx="240" cy="100" r="2.5" fill={INK} opacity="0">
  ...
  if (projectId === 7) return (
    <svg aria-hidden="true" width="100%" height="100%" viewBox="0 0 400 200" preserveAspectRatio="xMidYMid slice" xmlns="http://www.w3.org/2000/svg">
      <rect width="400" height="200" fill={BG} />
      <rect x="28" y="18" width="344" height="166" rx="6" fill={PANEL} stroke={PANEL_BORDER} strokeWidth="1" />
      <rect x="28" y="18" width="344" height="28" rx="6" fill="var(--color-border)" />
      <rect x="88" y="25" width="224" height="14" rx="7" fill={PANEL} />
      <rect x="96" y="29" width="90" height="5" rx="2" fill={MUTED} opacity="0.3" />
      {[0,1,2,3,4,5].map(i => (
        <g key={i} opacity="0">
          <rect x="48" y={56+i*20} width={210+(i%3)*28} height="7" rx="2" fill={MUTED} opacity="0.22" />
          <rect x={268+(i%2)*14} y={56+i*20} width="64" height="7" rx="2" fill={MUTED} opacity="0.15" />
  ...
  return (
    <svg aria-hidden="true" width="100%" height="100%" viewBox="0 0 400 200" preserveAspectRatio="xMidYMid slice" xmlns="http://www.w3.org/2000/svg">
      <rect width="400" height="200" fill={BG} />
      <rect x="88" y="18" width="224" height="166" rx="6" fill={PANEL} stroke={PANEL_BORDER} strokeWidth="1" />
      <rect x="88" y="18" width="224" height="32" rx="6" fill="var(--color-border)" />
      <text x="200" y="37" textAnchor="middle" fontSize="10" fill={MUTED} opacity="0.7" fontFamily="monospace">JUNE  2019</text>
      {(['S','M','T','W','T','F','S']).map((d, i) => (
        <text key={i} x={103+i*30} y={65} textAnchor="middle" fontSize="8" fill={MUTED} opacity="0.35" fontFamily="monospace">{d}</text>
      ))}
      {[...Array(5)].map((_, row) =>
        [...Array(7)].map((_, col) => {
          ...
          return (
            <g key={`${row}-${col}`}>
              {isTarget && (
                <rect x={92+col*30} y={72+row*22} width={22} height={18} rx="4" fill={INK} opacity="0">
                  <animate attributeName="opacity" values="0;0.14;0.14;0" dur="4s" repeatCount="indefinite" begin="1s" />
                </rect>
              )}
              <text x={103+col*30} y={85+row*22} textAnchor="middle" fontSize="9"
                fill={INK} opacity={isTarget ? 0.7 : 0.22} fontFamily="monospace">{day}</text>
            </g>
          );
        })
      )}
